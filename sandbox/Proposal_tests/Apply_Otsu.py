"""
Import preprocessed Sentinel 2 Images, applies Otsu-algorithm, narrow to broadband conversion and pimary surface type evaluation after Naegeli, 2018
...
#glacier_cloud_cropped_scene_file_08 = r'C:\Users\Lea Geibel\Documents\ETH\MASTERTHESIS\Data\Test 1\output\Clipped_B'+band+'_fiescher.tif'   # cropped scene for Fieschergletscher
band = '03'
...
#glacier_cloud_cropped_scene_file_03 = r'C:\Users\Lea Geibel\Documents\ETH\MASTERTHESIS\Data\Test 1\output\Clipped_B'+band+'_fiescher.tif'   # cropped scene for Fieschergletscher

snow_area_otsu = r'C:\Users\Lea Geibel\Documents\ETH\MASTERTHESIS\Data\Test 1\output\snow_area_otsu.tif'
...
plt.figure(figsize=(9, 4))
plt.plot(bins_center/10000, hist, lw=2)
plt.axvline(val/10000, color='k', ls='--')
plt.xlim(left=3/10000)  # remove black from histogram
plt.ylim(top=4000, bottom=0)

plt.xlabel('Data Value')
plt.ylabel('Frequency')
plt.title('Otsu-Threshold=%f' %(val/10000))
plt.grid(True)
