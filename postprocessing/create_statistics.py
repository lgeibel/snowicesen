...
==============
Create Statistical Evaluation (Confusion Matrix, Kappa, etc.) and plot results. For easier creating of the final plots and processing on  a local machine, the output variables are stored in a pickle file variables.p  for further processing
"""
...
#    print(cfg.PARAMS['count'])
  ...
  #  print("Entries = ", entries)
    ...
    plt.plot([0,len(snow_cover_arr)],kappa_asmag_tot*np.ones(len(snow_cover_arr)))
    plt.xlim(0,1)
    plt.ylim(0,1)
