...
from snowicesen.preprocessing import create_gdirs
from crampon.core.preprocessing import gis
import crampon
from shutil import rmtree
from oggm.workflow import execute_entity_task
from snowicesen.utils import GlacierDirectory
...
def init_glacier_regions_snowicesen(shapedf=None, reset=False, force=False, all_dates=True):
    """
    ...
    execute_entity_task(create_gdirs.define_glacier_region_snowicesen, new_gdirs)


    return gdirs

init_glacier_regions = init_glacier_regions_snowicesen
